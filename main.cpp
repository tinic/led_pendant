...
static void simple_ring(uint32_t ring_color, uint32_t bird_color) {
	for (; ;) {
    ...
    while(1) {
		switch(eeprom_settings.program_curr) {
			case	0:
					...
					break;
			case	1:
					simple_ring(0x400000, 0x400000);
					break;
			case	2:
					simple_ring(0x004000, 0x004000);
					break;
			case	3:
					simple_ring(0x000040, 0x000040);
					break;
			case	4:
					simple_ring(0x404000, 0x404000);
					break;
			case	5:
					simple_ring(0x004040, 0x004040);
					break;
			case	6:
					simple_ring(0x400040, 0x400040);
					break;
			case	7:
					simple_ring(0x404040, 0x404040);
					break;
			default:
					break;
		}
